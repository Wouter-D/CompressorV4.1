...
extern const juce::String m_ratioID;
extern const juce::String m_ratioName;

extern const juce::String m_attackID;
extern const juce::String m_attackName;
